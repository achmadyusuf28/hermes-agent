# obsidian.nix — Auto-converted from Hermes skill
...
with lib;
let
  cfg = config.hermes.skills.obsidian;
in
{
  options.hermes.skills.obsidian = {
    enable = mkEnableOption "Read, search, create, and edit notes in the Obsidian vault.";
  };

# songsee.nix — Auto-converted from Hermes skill
# Category: media
# Original: songsee
...
with lib;
let
  cfg = config.hermes.skills.songsee;
in
{
  options.hermes.skills.songsee = {
    enable = mkEnableOption "Audio spectrograms/features (mel, chroma, MFCC) via CLI.";
  };

# test-driven-development.nix — Auto-converted from Hermes skill
...
with lib;
let
  cfg = config.hermes.skills.test-driven-development;
in
{
  options.hermes.skills.test-driven-development = {
    enable = mkEnableOption "TDD: enforce RED-GREEN-REFACTOR, tests before code.";
  };

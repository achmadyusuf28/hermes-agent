...
CURATOR_REVIEW_PROMPT = (
    ...
    "REQUIRED: call skill_view(name) FIRST to load the current content; "
    "the tool will deny the mutation if you skip this read step.\n"
    "  - skill_manage action=create     — create a new umbrella SKILL.md\n"
    "  - skill_manage action=write_file — add a references/, templates/, "
    "or scripts/ file under an existing skill (the skill must already "
    "exist). REQUIRED: call skill_view(name, file_path=...) first.\n"
    ...
    "NOTE: terminal is only available in live (non-review) passes. "
    "In review mode, describe the mv/cp steps you WOULD take in your report.\n\n"
